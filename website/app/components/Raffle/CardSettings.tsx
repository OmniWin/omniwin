                ...
                {showStyle && (
                    <>
                        ...
                        {/* <div className="flex items-center bg-zinc-800 rounded-lg px-3 py-2"> */}
                            ...
                            {/* Active */}
                            <button onClick={() => setStyle(1)} type="button" className={classNames("py-2 px-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300", style === 1 && "bg-zinc-700")}>
                                <svg
                                    className={`h-4 w-4 ${style === 1 ? "fill-zinc-100 stroke-zinc-100" : "fill-zinc-500 stroke-zinc-500"}`}
                                ...
                                >
                                    ...
                                    <path d="M22 416H490V529C490 544.464 477.464 557 462 557H50C34.536 557 22 544.464 22 529V416Z" fill="transparent" stroke-width="44" />
                                    <path d="M98 491H414" stroke-width="37" stroke-linecap="round" />
                                </svg>
                            </button>
                            <button onClick={() => setStyle(2)} type="button" className={classNames("py-2 px-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300", style === 2 && "bg-zinc-700")}>
                                <svg
                                    className={`h-4 w-4 ${style === 2 ? "fill-zinc-100 stroke-zinc-100" : "fill-zinc-500 stroke-zinc-500"}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="512"
                                    height="584"
                                    viewBox="0 0 512 584"
                            ...
                            <button onClick={() => setStyle(3)} type="button" className={classNames("py-2 px-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300", style === 3 && "bg-zinc-700")}>
                                <svg
                                    className={`h-4 w-4 ${style === 3 ? "fill-zinc-100 stroke-zinc-100" : "fill-zinc-500 stroke-zinc-500"}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="512"
                                    height="579"
                                    viewBox="0 0 512 579"
                                >
                                    ...
                                    <path d="M22 318H490V529C490 544.464 477.464 557 462 557H50C34.536 557 22 544.464 22 529V318Z" fill="transparent" stroke-width="44" />
                                    <path d="M98 419H414" stroke-width="37" stroke-linecap="round" />
                                    <path d="M98 483H414" stroke-width="37" stroke-linecap="round" />
                                </svg>
                            </button>
                        </div>
                    </>
                    ...
                    <>
                        ...
                        {/* <div className="flex items-center bg-zinc-800 rounded-lg px-3 py-2"> */}
                            ...
                            <button
                                ...
                                type="button"
                                className={classNames("py-1.5 px-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300", display === "carousel" && "bg-zinc-700")}
                            >
                                <svg
                                    className={`${display === "carousel" ? "fill-zinc-100 stroke-zinc-100" : "fill-zinc-500 stroke-zinc-500"}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="24"
                            ...
                            <button
                                ...
                                type="button"
                                className={classNames("py-1.5 px-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300", display === "grid" && "bg-zinc-700")}
                            >
                                <svg
                                    className={`${display === 'grid' ? "fill-zinc-100 stroke-zinc-100" : "fill-zinc-500 stroke-zinc-500"}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="24"
                                    viewBox="0 -960 960 960"
                                    width="24"
