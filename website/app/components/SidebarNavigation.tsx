...
export const SidebarNavigation = () => {
    ...
    return (
        <>
            ...
            <div className={`hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col transition-all duration-300 ${sidebarToggleState.toggleSidebar ? "lg:w-16" : "lg:w-72"}`}>
                {/* Sidebar component, swap this element with another sidebar if you like */}
                {/* <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-zinc-950 px-6 pb-4"> */}
                <div className="md:opacity-100 w-4 transition-opacity duration-300 absolute -right-3 top-1/2 transform -translate-y-1/2">
                    <button onClick={() => dispatch(sidebarSlice.actions.setSidebarToggleState(!sidebarToggleState.toggleSidebar))} className="hidden rounded-md bg-zinc-950 px-0.5 py-[8px] md:block focus:outline-none">
                                                        ...
                                                        <>
                                                            ...
                                                            >
                                                                ...
                                                                {sidebarToggleState.toggleSidebar ? (
                                                                    ...
                                                                    <ChevronRightIcon className={classNames(open ? "rotate-90 text-zinc-500" : "text-zinc-400", "ml-auto h-5 w-5 shrink-0")} aria-hidden="true" />
                                                                )}
                                                            </Disclosure.Button>
                                                            <Disclosure.Panel as="ul" className="mt-1 px-2">
                                                                {item.children.map((subItem) => (
