...
import ChallengesList from "@/app/components/Challenges/ChallengesList";
...
const challengesCollors = [
    "stroke-emerald-400 fill-emerald-400/10 border-emerald-800",
    "stroke-blood-400 fill-blood-400/10 border-blood-800",
    "stroke-lemon-400 fill-lemon-400/10 border-lemon-800",
    "stroke-water-400 fill-water-400/10 border-water-800",
    "stroke-sky-400 fill-sky-400/10 border-sky-800",
    "stroke-violet-400 fill-violet-400/10 border-violet-800",
    "stroke-fuchsia-400 fill-fuchsia-400/10 border-fuchsia-800",
    "stroke-orange-400 fill-orange-400/10 border-orange-800",
    "stroke-indigo-400 fill-indigo-400/10 border-indigo-800",
    "stroke-teal-400 fill-teal-400/10 border-teal-800",
    "stroke-rose-400 fill-rose-400/10 border-rose-800",
    "stroke-lime-400 fill-lime-400/10 border-lime-800",
    "stroke-amber-400 fill-amber-400/10 border-amber-800",
];
                        ...
                        <div key={challenge.name} className="bg-zinc-900 rounded-2xl p-px flex flex-col border border-transparent transition-all ease-in-out duration-300 hover:translate-y-[-4px]">
                            <div
                                className={classNames(
                                    "flex flex-col h-full rounded-2xl border border-zinc-800 bg-gradient-to-tl from-zinc-900 to-zinc-800/30 shadow-xl hover:bg-zinc-800/50 group transition-all ease-in-out duration-300",
                                    challenge.completed && challengesCollors[key]
                                )}
                            >
                                <div className="relative flex-1 px-6 pb-8 pt-16 md:px-8">
                                    ...
                                    <h3 className="text-xl font-medium text-zinc-50 flex items-center justify-between gap-2">
                                        {challenge.name}
                                        {challenge.completed && <Badge variant="emerald">Completed</Badge>}
                                        {!challenge.completed && challenge.currentStep > 0 && <Badge variant="blue">In progress</Badge>}
                                    </h3>
