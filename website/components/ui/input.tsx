  ...
  "block w-full text-sm placeholder:text-zinc-400 focus:ring-0 sm:text-sm sm:leading-6 text-zinc-200",
  {
    variants: {
      variant: {
        ...
        backgroundBottomBorder: "bg-zinc-900 py-1.5 text-zinc-200 placeholder:text-zinc-400 focus:ring-0",
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(({
  className, variant, size, icon, iconSize = "h-5 w-5", label, id, ...props
}, ref) => {
