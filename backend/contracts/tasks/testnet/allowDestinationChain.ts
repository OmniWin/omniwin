...
task("allowDestinationChain", "Allow or disallow the destination chain on a given contract")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const abi = [
            "function allowlistDestinationChain(uint64 selector, bool allow)"  
        ];
        ...
        const txResponse = await contract.allowlistDestinationChain(selector, allow);
