...
/// entries count. So  ing entries has a complexity of O(1)
    ...
    CCIPReceiver
{
    ...
    function setWinnerActions(
        ...
        require(
            entryInfo.amountRaised >= funding.minimumFundsInWei,
    ...
    function _createRaffleFromSidechain(
        ...
        //create raffle from side chain with prize on side chain
